...
import com.example.nauraapps.databinding.FragmentTabCBinding

class TabCFragment : Fragment() {

    // 1. Inisialisasi View Binding menggantikan sistem inflate lama
    private var _binding: FragmentTabCBinding? = null
    private val binding get() = _binding!!

    // 2. Kumpulan data tiruan (Dummy Data) 50 Produk
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // 3. Setup Adapter dengan aksi klik item
        ...
        // 4. Konfigurasi komponen RecyclerView via View Binding
        binding.rvProducts.apply {
            // Menggunakan Mode Grid (2 Kolom)
            layoutManager = GridLayoutManager(requireContext(), 2)

            // Pasangkan komponen adapter
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        // Bersihkan memori binding saat fragment dihancurkan
        _binding = null
    }
}